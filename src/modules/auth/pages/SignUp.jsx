...
export default function SignUp() {
  ...
  const { firstName, lastName, email, mobileNumber, password, confirmPassword, dateOfBirth, height, weight, gender } = formData;
  ...
  return (
    <div className="min-h-screen bg-zinc-200 py-6 px-8 md:px-[8%]">
      ...
      <div className="container mx-auto w-full max-w-[550px] px-14 py-10 bg-zinc-50 rounded-2xl shadow-2xl">
        ...
        {mutation.isError && !Object.keys(validationErrors).length && (
