...
export default function Login() {
  ...
  return (
    <>
      <Navbar/>
      <ToastContainer />
      <div className="min-h-screen flex items-center justify-center pt-15 overflow-auto bg-zinc-200  py-6 px-8 md:px-[8%]">
        <div className="container mx-auto w-full max-w-[450px] p-14 bg-zinc-50 rounded-2xl shadow-2xl md:mt-16">
